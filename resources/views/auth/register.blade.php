    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h3><b><p class="text-center">Đại Diện Doanh Nghiệp Đăng Kí</p></b></h3></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="dangkicongty">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">Địa Chỉ</label>
